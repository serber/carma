...
def test_insert_and_recent(tmp_path):
    ...
    store.insert("2026-07-28T12:00:00+00:00", "123ABC02", 0.9, "KZ", "f1.jpg", "c1.jpg")
    store.insert("2026-07-28T12:01:00+00:00", "A123BC77", 0.8, "RU", "f2.jpg", "c2.jpg")
...
def test_recent_respects_limit(tmp_path):
    ...
    for i in range(5):
        store.insert(f"t{i}", f"PLATE{i}", 0.5, "unknown", f"f{i}.jpg", f"c{i}.jpg")
